...
export default function InvoicesTable() {
  ...
  return (
    <DataTable<Row>
      ...
      toolbar={
        <button onClick={() => router.push('/admin/finance/invoices/new')} className="kf-btn-primary flex items-center gap-1.5 whitespace-nowrap">
      ...
      actions={(inv) => (
        <>
          ...
          <button onClick={() => router.push(`/admin/finance/invoices/${inv.id}`)} aria-label="Edit" className="p-1.5 rounded-md text-zinc-500 hover:bg-zinc-100 hover:text-zinc-800 transition">
